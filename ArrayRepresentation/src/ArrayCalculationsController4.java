...
public class ArrayCalculationsController4 {
    ...
    void GettingOutput(ActionEvent event) {
        try {
            ...
            if (x < size) {
                ...
                int[] uniqueElements = ArraySolutions4.findUniqueElements(arr); // Call findUniqueElements with the arr array
                OutputArray.setText("Unique Elements: " + Arrays.toString(uniqueElements));
            }
