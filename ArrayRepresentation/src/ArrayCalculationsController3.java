...
public class ArrayCalculationsController3 {
    ...
    void GettingOutput(ActionEvent event) {
        try {
            ...
            if (x < size) {
                ...
                ArraySolutions3.reverseArray(arr); // Call reverseArray with the arr array
                OutputArray.setText("Reversed Array: " + Arrays.toString(arr));
            }
